    ...
    $(window).scroll(function () {
        if (matchMedia("only screen and (min-width: 1200px)").matches) {
            if ($(window).scrollTop() >= 50) {
                ...
                $(".header.logo-with-bg-shape .cmt-stickable-header")
...
/*------------------------------------------------------------------------------*/
    $(function () {
        ...
        if (typeof jQuery.fn.prettyPhoto == "function") {
            jQuery(
                'div.gallery a[href*=".jpg"], div.gallery a[href*=".jpeg"],div.gallery a[href*=".png"], div.gallery a[href*=".gif"]'
            ).each(function () {
            ...
            jQuery(
                '.gallery-item a[href*=".jpg"], .gallery-item a[href*=".jpeg"], .gallery-item a[href*=".png"], .gallery-item a[href*=".gif"]'
            ).each(function () {
                if (jQuery(this).attr("target") != "_blank") {
...
/*------------------------------------------------------------------------------*/
    ...
    $(".price-switch input").click(function () {
        if ($(this).is(":checked")) {
            $(this)
                .parents(".row")
                .find(".cmt-pricing-plan-inner")
                .addClass("secondary-plan");
        } else {
            $(this)
                .parents(".row")
                .find(".cmt-pricing-plan-inner")
                .removeClass("secondary-plan");
        }
    });
