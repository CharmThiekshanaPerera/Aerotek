                ...
                "image" == _getFileType(pp_images[set_position])
                    ? ((itemWidth = 57),
                      ...
                      (itemsPerPage = Math.floor(
                          (pp_dimensions.containerWidth - 100 - navWidth) /
                              itemWidth
                      )),
                      (itemsPerPage =
                ...
                return (
                    ...
                    (pp_images = isSet
                        ? jQuery.map(matchedObjects, function (n, i) {
                              if (
                                  -1 != $(n).attr(settings.hook).indexOf(theRel)
                              )
                                  return $(n).attr("href");
                          })
            ...
            ($.prettyPhoto.open = function (event) {
                return (
                    ...
                    -1 != movie_height.indexOf("%") &&
                        ((movie_height = parseFloat(
                            ($(window).height() * parseFloat(movie_height)) /
                                100 -
                                150
                        )),
                        (percentBased = !0)),
                    -1 != movie_width.indexOf("%") &&
                        ((movie_width = parseFloat(
                            ($(window).width() * parseFloat(movie_width)) /
                                100 -
                                150
                        )),
                        (percentBased = !0)),
