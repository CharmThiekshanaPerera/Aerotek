            ...
            <div class="container">
                ...
                <div class="row slick_slider" data-slick='{"slidesToShow": 3, "slidesToScroll": 3, "dots":false, "arrows":false, "autoplay":false, "infinite":true, "responsive": [{"breakpoint":1024,"settings":{"slidesToShow": 2}}, {"breakpoint":640,"settings":{"slidesToShow": 1}}]}'>
                    <div class="cmt-box-col-wrapper col-lg-4">
                        <div class="featured-imagebox featured-imagebox-services style1">
                            <div class="featured-thumbnail">
                                <a href="{{ route('services.index') }}"><img alt="Mechanical ventilation systems service" class="img-fluid" src="{{ asset('images/service-1.jpg') }}"></a>
                    ...
                    <div class="cmt-box-col-wrapper col-lg-4">
                        <div class="featured-imagebox featured-imagebox-services style1">
                            <div class="featured-thumbnail">
                                <a href="{{ route('services.index') }}"><img alt="Evaporative cooling systems service" class="img-fluid" src="{{ asset('images/service-2.jpg') }}"></a>
                                <div class="process-num">
                    ...
                    <div class="cmt-box-col-wrapper col-lg-4">
                        <div class="featured-imagebox featured-imagebox-services style1">
                            <div class="featured-thumbnail">
                                <a href="{{ route('services.index') }}"><img alt="Humidifier and dehumidifier systems service" class="img-fluid" src="{{ asset('images/service-3.jpg') }}"></a>
                                <div class="process-num">
                    ...
                    <div class="cmt-box-col-wrapper col-lg-4">
                        <div class="featured-imagebox featured-imagebox-services style1">
                            <div class="featured-thumbnail">
                                <a href="{{ route('services.index') }}"><img alt="Air conditioning systems service" class="img-fluid" src="{{ asset('images/service-4.jpg') }}"></a>
                                <div class="process-num">
                ...
                <div class="row cmt-boxes-spacing-px slick_slider" data-slick='{"slidesToShow": 4, "slidesToScroll": 4, "arrows":false, "autoplay":false, "dots":false, "infinite":true, "responsive":[{"breakpoint":1199,"settings": {"slidesToShow": 3}}, {"breakpoint":992,"settings":{"slidesToShow": 2}},{"breakpoint":620,"settings":{"slidesToShow": 1}}]}'>
                    <div class="cmt-box-col-wrapper col-lg-4 col-md-4 col-sm-6">
                        <div class="featured-imagebox featured-imagebox-portfolio style1">
                            <div class="cmt-box-view-overlay">
                                <div class="featured-thumbnail">
                                    <img alt="Natural ventilation project" class="img-fluid" height="750" src="{{ asset('images/project-1.jpg') }}" width="600">
                                </div>
                    ...
                    <div class="cmt-box-col-wrapper col-lg-4 col-md-4 col-sm-6">
                        <div class="featured-imagebox featured-imagebox-portfolio style1">
                            <div class="cmt-box-view-overlay">
                                <div class="featured-thumbnail">
                                    <img alt="Exhaust ventilation systems project" class="img-fluid" height="750" src="{{ asset('images/project-2.jpg') }}" width="600">
                                </div>
                                <div class="cmt-media-link">
                    ...
                    <div class="cmt-box-col-wrapper col-lg-4 col-md-4 col-sm-6">
                        <div class="featured-imagebox featured-imagebox-portfolio style1">
                            <div class="cmt-box-view-overlay">
                                <div class="featured-thumbnail">
                                    <img alt="Supply ventilation systems project" class="img-fluid" height="750" src="{{ asset('images/project-3.jpg') }}" width="600">
                                </div>
                                <div class="cmt-media-link">
                    ...
                    <div class="cmt-box-col-wrapper col-lg-4 col-md-4 col-sm-6">
                        <div class="featured-imagebox featured-imagebox-portfolio style1">
                            <div class="cmt-box-view-overlay">
                                <div class="featured-thumbnail">
                                    <img alt="Balanced ventilation systems project" class="img-fluid" height="750" src="{{ asset('images/project-4.jpg') }}" width="600">
                                </div>
                                <div class="cmt-media-link">
                    ...
                    <div class="cmt-box-col-wrapper col-lg-4 col-md-4 col-sm-6">
                        <div class="featured-imagebox featured-imagebox-portfolio style1">
                            <div class="cmt-box-view-overlay">
                                <div class="featured-thumbnail">
                                    <img alt="Recovery systems project" class="img-fluid" height="750" src="{{ asset('images/project-5.jpg') }}" width="600">
                                    <div class="cmt-media-link">
